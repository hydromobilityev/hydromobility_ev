...
ReactNativeHapticFeedback.trigger("impactLight", options);
    ...
    const navigate_faq_details = (data) => {
    ...
    const show_list = ({ item }) => (
        <TouchableOpacity activeOpacity={1} onPress={navigate_faq_details.bind(this, item)} style={{ flexDirection: 'row', padding: 20 ,backgroundColor:theme.surface,marginHorizontal:20,borderRadius:10,marginBottom:15}}>
