...
const Intro = () => {
  ...
  const slides = [
    {
      key: 1,
      title: t('Search A Car'),
      text: t('Start the new years with some superfood on your plate. Find your perfect restaurant with wide variety of mouth-watering foods'),
      image: require('.././assets/json/slider_1.json'),
      bg: colors.theme_bg_three,
    },
    {
      key: 2,
      title: t('Choose Your Route'),
      text: t('A light and crisp taste, lively color vegetables and fruits which packed with a burst of flavours'),
      image: require('.././assets/json/slider_2.json'),
      bg: colors.theme_bg_three,
    },
    {
      key: 3,
      title: t('Reach Your Destination'),
      text: t('On time deliver to variety of locations'),
