        ...
        if (vehicle_name) {
            navigate();
             ...
             showToast(
               "error",
               t('Validation error'),
               t('Please enter your vehicle name')
             );
    ...
    return (
        ...
        alignItems: 'center'}}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Text numberOfLines={1} style={{ color: theme.textPrimary, fontSize: f_xl, fontFamily: regular }}>{t('Enter your vehicle name')}</Text>
                <View style={{ margin: 5 }} />
                ...
                <View style={{ width: '80%' }}>
                    <View style={{ flexDirection: 'row',backgroundColor:theme.surface,borderRadius:10, borderWidth:.5,borderColor:theme.divider, }}>
                        <View style={{ width: '25%', alignItems: 'center', justifyContent: 'center', backgroundColor: theme.theme_bg_three }}>
                            <Icon type={Icons.MaterialIcons} name="drive-file-rename-outline" color={theme.textPrimary} style={{ fontSize: 30 }} />
                        </View>
