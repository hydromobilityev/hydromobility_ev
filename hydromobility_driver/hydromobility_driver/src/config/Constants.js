...
export const app_name = "Hydromobility EV Driver";
...
export const check_document_status = prefix+"check_document_status";
...
export const driver_approval = require(".././assets/json/driver_approval.json"); 
export const approved = require(".././assets/json/approved.json"); 
