...
export const img_url = 'enter_admin_link/uploads/';
...
export const create_stripe_intent = prefix + "create_stripe_intent";
...
//Map 
export const GOOGLE_KEY = "AIzaSyBll1KT_tnpeIhSn4gfpYTwixDHe-OjHfE";
export const ROUTEMAPPY_KEY = "ROUTEMAPPY_KEY";

export const FLUTTERWAVE_KEY = "FLUTTERWAVE_KEY";
export const PAYSTACK_KEY = "PAYSTACK_KEY";
...
export const REVERSE_GEOCODE = 'https://api.routemappy.com/geocode?';
export const AUTOCOMPLETE = 'https://api.routemappy.com/nearest?q=';
export const STRIPE_PKTEST="STRIPE_PKTEST"
export const STRIPE_SKTEST="STRIPE_SKTEST"
export const CLIENT_SECRET_KEY="CLIENT_SECRET_KEY"
...
export const chat_bg_dark = require(".././assets/img/chat_bg_dark.png");


export const income_icon = require(".././assets/img/income.png");
export const expense_icon = require(".././assets/img/expense.png");
export const profile = require(".././assets/img/temp/profile.jpg");
...
export const location = require(".././assets/json/location.json");
// export const refer = require(".././assets/json/01.json"); 
export const share = require(".././assets/json/share.json"); 
export const no_internet = require(".././assets/json/no_internet.json"); 
export const rmtiles_routemappy = require('.././assets/json/rmtiles_routemappy.json'); 
