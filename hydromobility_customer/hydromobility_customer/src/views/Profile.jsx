...
const Profile = (props) => {
  ...
  const call_get_profile = () => {
    setLoading(true);
    axios.post(api_url + get_profile, { customer_id: global.id, lang: i18n.language })
      .then(async (response) => {
        setLoading(false);
              ...
              {profileFields.map((item, index) => (
                <View key={index} style={{ marginBottom: 20 }}>
                  ...
                  <TouchableOpacity
                    ...
                    <View style={{ width: 50, backgroundColor: theme.surface, justifyContent: 'center', alignItems: 'center' }}>
