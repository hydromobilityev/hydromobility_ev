            ...
            global.first_name = first_name;
                setLoading(false);
                   showToast(
                     ...
                     t('Your first name has been updated')
                   );
    ...
    return (
        ...
        alignItems: 'center'}}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Text numberOfLines={1} style={{ color: theme.textPrimary, fontSize: f_xl, fontFamily: regular }}>{t('Enter your first name')}</Text>
                <View style={{ margin: 5 }} />
                <Text numberOfLines={1} style={{ color: theme.textSecondary, fontSize: f_xs, fontFamily: normal }}>{t('You need enter your first name')}</Text>
                <View style={{ margin: 20 }} />
