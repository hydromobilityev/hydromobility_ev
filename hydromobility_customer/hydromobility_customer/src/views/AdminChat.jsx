...
const AdminChat = () => {
  ...
  console.log(base_url+'customer_chat/'+global.id)
  // const navigate_home = () =>{
  //   navigation.dispatch(
  //       CommonActions.reset({
  //           index: 0,
      ...
      <StatusBar backgroundColor={colors.theme_bg}/>
       <View style={[styles.header]}>
            ...
            <View activeOpacity={1} style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
                <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontFamily: bold }}>{t('Chat')} ({t('Admin')})</Text>
            </View>
        </View>       
        <WebView 
