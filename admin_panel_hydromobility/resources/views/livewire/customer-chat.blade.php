             ...
             @if(isset($messages))
                @foreach($messages as $message)
                    ...
                    <div style="padding:10px;">
                      <h5><span @if(!$message->is_admin) class="time-left" @else class="time-right" @endif style="color:#000;">{{ $message->message}}</span></h5>
                      <!--<p @if(!$message->is_admin) class="time-left" @else class="time-right" @endif>{{$message->created_at->diffForHumans()}}</p>-->
                    </div>
                    @endif
