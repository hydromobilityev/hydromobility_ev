...
<link rel="stylesheet" href="{{ env('APP_URL') }}http://127.0.0.1:8000/vendor/laravel-admin/AdminLTE/dist/css/AdminLTE.min.css">
    ...
    <script type="text/javascript" async defer src="https://maps.googleapis.com/maps/api/js?key={{ env('MAP_KEY') }}&libraries=places&callback=initMap">
        </script>
...
<div class="row">
    ...
    <!-- Firebase -->
        ...
        <script>
            ...
            var config = {
                            apiKey: "AIzaSyDDT_AY5sthCYLgaY8VSZ3f7rGZAR-HQB4",
                            authDomain: "hydromobility-8bd4a.firebaseapp.com",
                            databaseURL: "https://hydromobility-8bd4a-default-rtdb.firebaseio.com",
                            projectId: "hydromobility-8bd4a",
                            storageBucket: "hydromobility-8bd4a.firebasestorage.app",
                            messagingSenderId: "1089171095905",
                            appId: "1:1089171095905:web:eaaf1bf9402a677f9dc520"
                            };
