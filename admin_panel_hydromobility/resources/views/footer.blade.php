  ...
  <footer class="footer bg-theme-light/50">
      <div class="container">
          <div class="row gx-5 pb-10 pt-[52px]">
              <div class="col-12 mt-12 md:col-6 lg:col-3">
                  <a href="index.html">
                      <img src="{{ env('IMG_URL').$app_settings->logo }}" width="50" height="50" alt="" />
                  </a>
                  <p class="mt-6">
              ...
              <div class="col-12 mt-12 md:col-6 lg:col-3">
                  <h6>Socials</h6>
                  <p>{{ $contact_settings->phone_number }}</p>
                  <p>{{ $contact_settings->email }}</p>
                  <ul class="social-icons mt-4 lg:mt-6">
                      <li>
                          <a href="{{ $website_settings->facebook_link }}">
                      ...
                      <li>
                          <a href="{{ $website_settings->twitter_link }}">
                      ...
                      <li>
                          <a href="{{ $website_settings->linkedin_link }}">
                      ...
                      <li>
                          <a href="{{ $website_settings->skype_link }}">
      ...
      <div class="container max-w-[1440px]">
          <div class="footer-copyright mx-auto border-t border-border pb-10 pt-7 text-center">
              <p>Designed And Developed by <a href="{{ env('APP_URL') }}" target="_blank">{{ env('APP_NAME')}}</a></p>
          </div>
      </div>
  </footer>
  <!-- footer -->
  ...
  <!-- Swiper JS -->
  <script src="{{ asset('web/plugins/swiper/swiper-bundle.js') }}"></script>
  <script src="{{ asset('web/plugins/shufflejs/shuffle.js') }}"></script>
