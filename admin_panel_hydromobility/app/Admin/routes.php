...
Route::group([
    ...
    $router->get('get_policy_titles', 'GeneralController@GetPolicyTitles');
    ...
    $router->resource('map_settings', MapSettingController::class);
    ...
    $router->resource('operator-vehicles', OperatorVehicleController::class);

    $router->resource('our_services', OurServiceController::class);
    $router->resource('testimonials', TestimonialController::class);
    $router->resource('website_settings', WebsiteSettingController::class);
    $router->resource('term_conditions', TermConditionController::class);
    $router->resource('app_details', AppDetailController::class);
    $router->resource('how_it_works', HowItWorkController::class);

    //Ccrporate customer
    $router->resource('corporate-customers', CorporateCustomerController::class);
    $router->resource('corporate-customer-requests', CorporateCustomerRequestController::class);
    $router->resource('corporate_tutorials', CorporateTutorialController::class);
    $router->resource('groups', GroupController::class);
    $router->resource('policies', PolicyController::class);
    $router->resource('payment_statements', PaymentStatementController::class);
    $router->resource('corporate_agents', CorporateAgentController::class);
});
