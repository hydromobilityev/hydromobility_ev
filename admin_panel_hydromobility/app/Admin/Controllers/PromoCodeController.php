...
class PromoCodeController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $corporates = CorporateCustomer::pluck('first_name', 'id');

        $form->select('customer_id', __('Customer'))->options($customers)->default(0);
        $form->select('corporate_customer_id', __('Corporate Customer'))->options($corporates)->default(0);
        ...
        $form->saving(function (Form $form) {
            ...
            if (!$form->corporate_customer_id) {
                $form->corporate_customer_id = 0;
            }
        });
