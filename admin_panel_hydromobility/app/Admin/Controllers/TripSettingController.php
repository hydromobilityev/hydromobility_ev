...
class TripSettingController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('service_fee', __('Service Fee (Percentage)'));
        ...
        $grid->column('gth_searching_radius', __('GTH searching radius (KM)'));
    ...
    protected function form()
    {
        ...
        $form->decimal('service_fee', __('Service Fee'))->rules('required');
        ...
        $form->decimal('gth_searching_radius', __('GTH searching radius'))->rules('required');
